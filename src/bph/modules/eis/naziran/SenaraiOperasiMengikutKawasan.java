 ...
 * 
 */
public class SenaraiOperasiMengikutKawasan extends LebahModule {	
	/**
	 * 
	 */
	...
	public String start() {
		...
		context.put("laporan", "ikut_kawasan");
	...
	private String getTajukLaporan() {
		String tajukLaporan = "Bilangan Operasi Mengikut Kawasan";
	...
	private String getSQL() {
		...
		sql = "SELECT ruj_kawasan_utk.keterangan AS x,"
				+ " count(operasi.id_operasi) AS y"
				+ " FROM    ruj_kawasan_utk" + " LEFT JOIN"
				+ " (SELECT utk_operasi.id AS id_operasi,"
				+ " utk_operasi.id_kawasan AS id_kawasan"
				+ " FROM utk_operasi) operasi"
				+ " ON operasi.id_kawasan = ruj_kawasan_utk.id"
				+ " GROUP BY ruj_kawasan_utk.id"
				+ " ORDER BY ruj_kawasan_utk.keterangan ASC";
