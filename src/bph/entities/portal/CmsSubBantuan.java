...
@Entity
@Table(name = "cms_sub_bantuan")
public class CmsSubBantuan {
	...
	@ManyToOne
	@JoinColumn(name = "id_bantuan")
	private CmsBantuan bantuan;
	...
	public CmsBantuan getBantuan() {
		return bantuan;
	}

	public void setBantuan(CmsBantuan bantuan) {
