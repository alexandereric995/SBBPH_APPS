...
public class LaporanSenaraiButiranTempahanGelanggang extends ReportServlet{
	
	static Logger myLog = Logger.getLogger(LaporanSenaraiButiranTempahanGelanggang.class);
	public LaporanSenaraiButiranTempahanGelanggang() {
		
		
		super.setFolderName("utiliti");
		super.setReportName("LaporanSenaraiButiranTempahanGelanggang");
