...
public class OperatorCheckedIn extends LebahRecordTemplateModule<RppPermohonan> {
	...
	@Override
	public String getPath() {return "bph/modules/rpp/operatorCheckedIn"; }
	...
	public void begin() {
		...
		this.addFilter("status.id = '1425259713421' ");
