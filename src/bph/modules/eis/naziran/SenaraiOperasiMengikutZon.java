 ...
 * 
 */
public class SenaraiOperasiMengikutZon extends LebahModule {	
	/**
	 * 
	 */
	...
	private String getTajukLaporan() {
		String tajukLaporan = "Bilangan Operasi Mengikut Zon";
	...
	private String getSQL() {
		...
		sql = "SELECT ruj_zon_utk.keterangan AS x,"
				+ " count(operasi.id_operasi) AS y" + " FROM ruj_zon_utk"
				+ " LEFT JOIN" + " (SELECT utk_operasi.id AS id_operasi,"
				+ " utk_operasi.id_zon AS id_zon"
				+ " FROM utk_operasi) operasi"
				+ " ON operasi.id_zon = ruj_zon_utk.id"
				+ " GROUP BY ruj_zon_utk.id"
				+ " ORDER BY ruj_zon_utk.keterangan ASC";
