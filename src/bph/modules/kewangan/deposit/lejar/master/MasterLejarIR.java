...
public class MasterLejarIR extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	private static String path = "bph/modules/kewangan/deposit/lejar/master/rumahPeranginan/";
	static Logger myLogger = Logger.getLogger(MasterLejarIR.class);
	...
	private List<KewDeposit> dbListPendeposit() {
		...
		try {
			...
			String sql = "select a.id from kew_deposit a where a.id_kod_hasil = '72311' "+
						 ...
						 " and ifnull(a.flag_bayar,'T') = 'Y' order by a.tarikh_bayaran asc";
