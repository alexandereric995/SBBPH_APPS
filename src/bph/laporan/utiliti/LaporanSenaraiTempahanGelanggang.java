...
public class LaporanSenaraiTempahanGelanggang extends ReportServlet{
	
	static Logger myLog = Logger.getLogger(LaporanSenaraiTempahanGelanggang.class);
	public LaporanSenaraiTempahanGelanggang() {
		
		
		super.setFolderName("utiliti");
		super.setReportName("LaporanSenaraiTempahanGelanggang");
