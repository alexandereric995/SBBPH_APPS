...
public class LupaKataLaluanMailer {
	
	private boolean enableMail = true;
	private static LupaKataLaluanMailer instance;
	
	private LupaKataLaluanMailer() {
		
	}
	
	public static LupaKataLaluanMailer get() {
		if ( instance == null ) instance = new LupaKataLaluanMailer();
		return instance;
	}
	...
	public void hantarPassword(String emel, String idNo, String pass) {
		...
		subject = "SBBPH :: Lupa Kata Laluan";
