...
public class PengesyoranPenyediaanJKHRecordModule extends RekodKunciRecordModule {
	...
	public void doOverideFilterRecord() {
		...
		this.addFilter("status.id in ('1426130691708')"); //PENGESYORAN JKH
		...
		context.put("flagSkrin", "PengesyoranPenyediaanJKHRecordModule");
	}
}
