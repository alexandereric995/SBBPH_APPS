 ...
 * 
 */
public class SenaraiOperasiMengikutJenisOperasi extends LebahModule {
	/**
	 * 
	 */
	...
	public String start() {
		...
		context.put("laporan", "jenis_operasi");
	...
	private String getTajukLaporan() {
		String tajukLaporan = "Bilangan Operasi Mengikut Jenis Operasi";
	...
	private String getSQL() {
		...
		sql = "SELECT ruj_jenis_operasi_utk.keterangan AS x,"
				+ " count(operasi.id_operasi) AS y"
				+ " FROM    ruj_jenis_operasi_utk" + " LEFT JOIN"
				+ " (SELECT utk_operasi.id AS id_operasi,"
				+ " utk_operasi.id_jenis_operasi AS id_jenis_operasi"
				+ " FROM utk_operasi) operasi"
				+ " ON operasi.id_jenis_operasi = ruj_jenis_operasi_utk.id"
				+ " GROUP BY ruj_jenis_operasi_utk.id"
				+ " ORDER BY ruj_jenis_operasi_utk.keterangan ASC";
