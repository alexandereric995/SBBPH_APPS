 ...
 * 
 */
public class SenaraiPermohonanGelanggangMengikutBulanTahunSemasa extends
		LebahModule {
	...
	private String getTajukLaporan() {
		String tajukLaporan = "Bilangan Permohonan Gelanggang Mengikut Bulan (Tahun Semasa)";
	...
	private String getSQL() {
		...
		sql = "SELECT ruj_bulan.keterangan AS x, count(permohonan.id) AS y"
			...
			+ " AND util_permohonan.id_gelanggang is not null) permohonan"
			+ " ON permohonan.bulan = ruj_bulan.id"
			+ " GROUP BY ruj_bulan.id " + " ORDER BY ruj_bulan.id + 0";
	...
	private String getPath() {
		return "bph/modules/eis/utiliti/senaraiPermohonanGelanggangMengikutBulanTahunSemasa";
	}
