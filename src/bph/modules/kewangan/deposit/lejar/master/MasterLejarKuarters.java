...
public class MasterLejarKuarters extends AjaxBasedModule {

	private static final long serialVersionUID = 1L;
	private static String path = "bph/modules/kewangan/deposit/lejar/master/kuarters/";
	static Logger myLogger = Logger.getLogger(MasterLejarKuarters.class);
	...
	private List<KewDeposit> dbListPendeposit() {
		...
		try {
			...
			String sql = "select a.id from kew_deposit a where a.id_kod_hasil = '72310' "+
						 ...
						 " and ifnull(a.flag_warta,'T') <> 'Y' order by a.tarikh_bayaran desc";
