...
/**
 * @author rzai
 * Laporan keputusan mesyuarat (lulus / tolak / tangguh / lulus bersyarat)
 */
public class KeputusanMesyuaratMengikutJenisKeputusan extends LebahModule {
	...
	private String getTajukLaporan() {
		String tajukLaporan = "Laporan Keputusan Mesyuarat Mengikut Status / Bulan / Tahun";
