...
public class KEWResitAsal extends ReportServlet{
	
	private MyPersistence mp;	
	static Logger myLog = Logger.getLogger(KEWResitAsal.class);
	
	public KEWResitAsal() {		
		
		super.setFolderName("kewangan");
		super.setReportName("KEWResitAsal");
	}
	...
	public void doProcessing(HttpServletRequest request,
		...
		try {		
			...
			if(parameters.get("idResit") != null){				
				...
				if (resit != null) {
					...
					if (resit.getTarikhBayaran() != null) {
						if (resit.getTarikhBayaran().after(startDate) || resit.getTarikhBayaran().equals(startDate)) {
							//NEW TEMPLATE
							super.setReportName("KEWResitAsalV2");
						}
					}
