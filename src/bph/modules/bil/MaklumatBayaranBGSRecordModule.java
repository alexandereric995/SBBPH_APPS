...
public class MaklumatBayaranBGSRecordModule extends MaklumatBayaranRecordModule {
	...
	public void doOverideFilterRecord() {
		...
		try {			
			...
			if ("(BGS) Penyemak".equals(userRole)){
				this.addFilter("statusBil.id = '1433131904918'");
			}
			
			this.addFilter("pendaftaranBil.seksyen.id = '06'");
