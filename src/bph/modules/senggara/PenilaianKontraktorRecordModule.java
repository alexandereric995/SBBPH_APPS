...
public class PenilaianKontraktorRecordModule extends RekodIndenKerjaRecordModule {
	...
	public void doOverideFilterRecord() {
		...
		this.addFilter("status.id = '17859229601108'"); //PENILAIAN KONTRAKTOR
		...
		context.put("flagSkrin", "PenilaianKontraktorRecordModule");
	}
}
