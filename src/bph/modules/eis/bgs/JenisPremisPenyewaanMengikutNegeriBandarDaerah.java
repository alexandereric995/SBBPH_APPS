...
/**
 * @author rzai
 * Statistik jenis premis penyewaan mengikut negeri / bandar / daerah
 */
public class JenisPremisPenyewaanMengikutNegeriBandarDaerah extends LebahModule {
	...
	public String start() {
		...
		context.put("laporan", "jenis_premis");
		return getPath() + "/start.vm";
	}

	private String getTajukLaporan() {
		String tajukLaporan = "Jenis Premis Penyewaan Mengikut Negeri/ Bandar/ Daerah/ Jenis Premis";
