...
/**
 * @author rzai
 * Statistik jenis premis penyewaan (pejabat / rumah kedai / kediaman / lain lain)
 */
public class JenisPremisPenyewaanMengikutJenisPremis extends LebahModule {
	...
	private String getTajukLaporan() {
		String tajukLaporan = "Bilangan Kuarters Mengikut Status Berpenghuni";
