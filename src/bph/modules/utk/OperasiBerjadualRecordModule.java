 ...
 *
 */
public class OperasiBerjadualRecordModule extends LebahRecordTemplateModule<UtkOperasi>{

	static Logger myLogger = Logger.getLogger("OperasiBerjadualRecordModule");
	...
	private void addfilter() {
		...
		this.addFilter("flagOperasi= '1'"); // OPERASI BERJADUAL
	}

	@Override
	public boolean delete(UtkOperasi r) throws Exception {
		// TODO Auto-generated method stub
		System.out.println("ceking id ======== " + get("idOperasi"));
		...
		if(listKesalahan.size() > 0){
			for(UtkKesalahan d : listKesalahan){
				System.out.println("ceking idkesalahan = " + d.getId());
	...
	public String getPath() {
		// TODO Auto-generated method stub
		return "bph/modules/utk/operasi/operasiBerjadual";
	}

//	public String getSubPath() {
//		// TODO Auto-generated method stub
//		return "bph/modules/utk/formMaklumatKesalahan";
//	}
	...
	public void save(UtkOperasi r) throws Exception {
		...
		r.setFlagOperasi("1"); //OPERASI BERJADUAL
		//addbyzul
//		r.setNoFail(get("noFail"));
	...
	public String saveMaklumatOperasi() throws ParseException {
		...
		mo.setFlagOperasi("1"); //OPERASI BERJADUAL
		//addbyzul
//		r.setNoFail(get("noFail"));
	...
	//addbyzul
	String findFasa = get("idFindFasa");
	String findBlok = get("idFindBlok");
	...
	//addbyzul
	map.put("fasa.id", findFasa);
	map.put("blok.id", findBlok);
...
//		return getPath() + "/maklumatPermohonan/start.vm";
	...
	public String addPesalah() {
        ...
        */
		...
		String noFail = get("noFile");
		String noUnit = get("noUnit");
		String idNegeri = get("findNegeri");
		String idBandar = get("findBandar");
		
		List<KuaPenghuni> pesalahList = searchListPesalah(noKp, namaPesalah, noFail, noUnit, idNegeri, idBandar);
	...
	private List<KuaPenghuni> searchListPesalah(String noKp, String namaPesalah, String noFail, String noUnit, String idNegeri, String idBandar) {
		...
		if(!noFail.equalsIgnoreCase("")){
			sql = sql + " and x.noFailLama like ('%" + noFail + "%')";
		}
	...
	public String saveKebersihan() {
		String statusInfo="";
		System.out.println("ceking idke ======= " + get("idKebersihan"));
...
//	}
	...
	public String saveKesalahan() {
		...
		rekod.setJenisOperasi(db.find(JenisOperasiUtk.class, operasi.getJenisOperasi()));
		rekod.setJenisPelanggaranSyarat(db.find(JenisPelanggaranSyaratUtk.class, operasi.getJenisPelanggaranSyarat()));
...
//		return getPath() + "/entry_page.vm";
	...
	public String savePenguncian() throws Exception {
		String statusInfo = "";
...
//	}
	...
	@Command("")
	public String functionJenisKenderaan(){
		
		context.put("", getParam("vmIdJenisKenderaan"));
