...
public class AgihanTugasPemantauanKerjaRecordModule extends RekodIndenKerjaRecordModule {
	...
	public void doOverideFilterRecord() {
		...
		this.addFilter("status.id = '17859229601072'"); //AGIHAN TUGAS PEMANTAUAN KERJA
		...
		context.put("flagSkrin", "AgihanTugasPemantauanKerjaRecordModule");
	}
}
