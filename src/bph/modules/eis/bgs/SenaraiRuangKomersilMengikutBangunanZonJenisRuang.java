 ...
 */
public class SenaraiRuangKomersilMengikutBangunanZonJenisRuang extends LebahModule {
...
//		context.put("selectLokasiKuarters", dataUtil.getListLokasiPermohonan());
		...
		context.put("laporan", "senarai_ruang_komersil");
		return getPath() + "/start.vm";
	}

	private String getTajukLaporan() {
		String tajukLaporan = "Senarai Ruang Komersil JRK Mengikut Negeri / Bandar";
