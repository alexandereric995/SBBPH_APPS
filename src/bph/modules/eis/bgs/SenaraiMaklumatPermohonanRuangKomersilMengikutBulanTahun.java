...
/**
 * @author rzai
 * Laporan senarai maklumat pemohon/penyewa baru Ruang komersil mengikut bulan / tahun.
 */
public class SenaraiMaklumatPermohonanRuangKomersilMengikutBulanTahun extends LebahModule {
	...
	public String start() {
		...
		context.put("selectStatusRuangKomersil", getListStatusRK());
		context.put("util", new Util());
		context.put("selectedTab", 0);
		context.put("path", getPath());
		context.put("laporan", "senarai_permohonan_ruang_komersil");
		return getPath() + "/start.vm";
	}

	public List<Status> getListStatusRK() {
		DbPersistence db = new DbPersistence();
		List<Status> list = db.list("select x from Status x where x.id in ('1433140179898','1433140179901','1433140179904','1433140179907','1433140179910','1433314239453','1434079231886','1434441177868') order by x.keterangan asc");
		return list;
	}

	private String getTajukLaporan() {
		String tajukLaporan = "Senarai Maklumat Permohonan JRK Mengikut Status / Bulan / Tahun";
