...
public class FrmKuaPermohonanDowngradeRecord extends FrmKuaPermohonanRecord {
	...
	public void begin() {
		...
		addFilter("flagMohonDowngrade ='Y'");
		addFilter("flagLulusDowngrade is null");
		...
		context.put("downgrade", "ya");
		context.put("upgrade", "tidak");
	...
	public Map<String, Object> searchCriteria() throws Exception {
		...
		r.put("dateMohonDowngrade", new OperatorDateBetween(
				getDate("findTarikhMohonDowngrade"),
				getDate("findTarikhMohonDowngrade")));
		return r;
	}
	...
	public String hantarSemakan() {
		...
		try {
			...
			r.setStatusDalaman("DOWNGRADE");
			r.setFlagLulusDowngrade("Y");
			mp.begin();
			mp.commit();
			success = true;
		} catch (Exception e) {
		...
		List<String> kelasKuarters = new ArrayList<String>();
		if (k1 != null)
