...
public class FrmKuaPermohonanTukarLokasiRecord extends FrmKuaPermohonanRecord {
	...
	public void begin() {
		...
		addFilter("flagMohonTukar ='Y'");
		addFilter("flagLulusTukar is null");
		//addFilter("statusDalaman=''");
		//addFilter("status.id IN ('1431292165723')");
	...
	public Map<String, Object> searchCriteria() throws Exception {
		...
		r.put("dateMohonTukar", new OperatorDateBetween(
				getDate("findTarikhMohonTukar"),
				getDate("findTarikhMohonTukar")));
		return r;
	}
	...
	public String hantarSemakan() {
		...
		try {
			...
			r.setStatusDalaman("TUKAR");
			r.setFlagLulusTukar("Y");
			mp.begin();
			mp.commit();
			success = true;
		} catch (Exception e) {
