 ...
 * 
 */
public class SenaraiKesalahanRinganMengikutJenisKesalahan extends LebahModule {
	/**
	 * 
	 */
	...
	private String getTajukLaporan() {
		String tajukLaporan = "Bilangan Kesalahan Ringan Mengikut Jenis Kesalahan";
	...
	private String getSQL() {
		...
		sql = "SELECT ruj_jenis_pelanggaran_syarat_utk.keterangan AS x,"
				...
				+ " WHERE ruj_jenis_pelanggaran_syarat_utk.flag_kes = '1'"
