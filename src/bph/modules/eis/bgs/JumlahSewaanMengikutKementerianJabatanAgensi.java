...
/**
 * @author rzai
 * Jumlah sewaan bulanan mengikut kementerian / jabatan / agensi
 */
public class JumlahSewaanMengikutKementerianJabatanAgensi extends LebahModule {
	...
	public String start() {
		...
		context.put("laporan", "jumlah_sewaan");
		return getPath() + "/start.vm";
	}

	private String getTajukLaporan() {
		String tajukLaporan = "Jumlah Sewaan Bulanan Mengikut Kementerian / Jabatan / Agensi";
	...
	public String selectJabatan() throws Exception {
		...
		List<Agensi> list = getListAgensiBGS(idKementerian);
		context.put("selectJabatan", list);
		return getPath() + "/selectJabatan.vm";
	}
	
	public List<Agensi> getListAgensiBGS(String idKementerian) {
		DbPersistence db = new DbPersistence();
		@SuppressWarnings("unchecked")
		List<Agensi> list = db.list("select x from Agensi x where x.kementerian.id = '"
