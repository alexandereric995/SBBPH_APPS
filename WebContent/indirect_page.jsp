...
<center>
  <table border="0" cellpadding="0" cellspacing="0" width="722">
      ...
      <td><div align="left" class="style3">
          ...
          <% 
							...
							else
							{
          					...
          					if (fpx_fpxTxnId != null && fpx_fpxTxnId != "") {
								...
								try {
								    ...
								    String sql= "INSERT INTO fpx_records(fpxTxnId, buyerBankBranch, buyerBankId, buyerIban, buyerId, buyerName," 
    ...
    <tr>
      ...
      <td><div align="left" class="style3">
		<%
					...
					if ( fpx_fpxTxnTime != null && fpx_fpxTxnTime != "" ) {
						Date transactionDate = sdfSource.parse(fpx_fpxTxnTime);
						out.print(sdf.format(transactionDate));
					}					
		%>
        </div></td>
    </tr>
    ...
    <tr>
      <td align="left"><div align="left"><strong><i>Bank</i></strong></div></td>
      <td>:</td>
      <td><div align="left" class="style3"><%=fpx_buyerBankBranch%></div></td>
    </tr>
    <tr>
