...
public class KutipanDataFailPenyewaBGS extends AjaxBasedModule {
	...
	private static final String idSeksyen = "06";
	...
	public String doTemplate2() throws Exception {
		...
		try {
			...
			if ("doSemakNoFail".equals(command)) {
				...
				List<RkRuangKomersil> listRuang = mp.list("select x from RkRuangKomersil x where x.flagSewa = 'T' and x.flagAktif = 'Y' and x.seksyen.id = '" + idSeksyen + "' order by x.idRuang asc");
				...
				fail = new RkFail();
				fail.setNoFail(getParam("noFail").trim());
