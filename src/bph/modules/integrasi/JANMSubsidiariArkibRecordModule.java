...
public class JANMSubsidiariArkibRecordModule extends AjaxBasedModule {
	...
	private String path = "bph/modules/integrasi/JANMSubsidiariArkib";
	...
	public String doTemplate2() throws Exception {
		...
		try {
			...
			String sql = "";
			List<IntJANMRekodArkib> listRekod = null;
			if ("doCarian".equals(command)) {
				
				sql = "select x from IntJANMRekodArkib x where x.id is not null";
				...
				if (!getParam("findDepartmentCode").equals("")) {
					sql = sql + " and x.departmentCode = '" + getParam("findDepartmentCode") + "'";
				}
