...
public class InvoisSewaBulanan extends ReportServlet {

	static Logger myLog = Logger.getLogger(InvoisSewaBulanan.class);
	private MyPersistence mp;

	public InvoisSewaBulanan() {

		super.setFolderName("rk");
		super.setReportName("InvoisSewaBulanan");
	}
